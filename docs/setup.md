...
3. **Deploy from GitHub**  
   A [GitHub Actions workflow](../.github/workflows/deploy.yml) runs on every **push to the production branch AND tests passed** and calls your deployer as a webhook. To use it, add a **repository secret** in GitHub:
